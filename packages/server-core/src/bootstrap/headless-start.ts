...
import { CONFIG_DIR, ensureConfigDir, loadStoredConfig, saveConfig } from '@craft-agent/shared/config'
...
export interface ServerBootstrapOptions<TSessionManager, THandlerDeps> {
  ...
  /** WebSocket handshake bearer validator (defaults to server token equality). */

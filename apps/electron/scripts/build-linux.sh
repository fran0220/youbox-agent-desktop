...
echo "=== Building OriginAI AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: OriginAI-x86_64.AppImage or OriginAI-aarch64.AppImage
BUILT_APPIMAGE_NAME="OriginAI-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: OriginAI-x64.AppImage, OriginAI-arm64.AppImage
APPIMAGE_NAME="OriginAI-${ARCH}.AppImage"

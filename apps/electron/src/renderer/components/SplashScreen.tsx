...
import { OriginCoworksSymbol } from './icons/OriginCoworksSymbol'
...
/**
 * SplashScreen - Shows OriginCoworks mark during app initialization
 *
...
export function SplashScreen({ isExiting, onExitComplete }: SplashScreenProps) {
  return (
    ...
    >
      ...
      >
        <OriginCoworksSymbol className="h-8 text-accent" />
      </motion.div>
    </motion.div>
  )
}

...
async function getExpectedChannels(): Promise<Set<string>> {
  ...
  const [
    ...
    import('@craft-agent/server-core/handlers/rpc/canvas-asset'),
    import('@craft-agent/server-core/handlers/rpc/canvas-image'),
    import('@craft-agent/server-core/handlers/rpc/design'),
    import('@craft-agent/server-core/handlers/rpc/files'),
    import('@craft-agent/server-core/handlers/rpc/gamestudio'),
  ...
  return new Set([
    ...
    ...canvasAsset.HANDLED_CHANNELS,
    ...canvasImage.HANDLED_CHANNELS,
    ...design.HANDLED_CHANNELS,
    ...files.HANDLED_CHANNELS,
    ...gamestudio.HANDLED_CHANNELS,

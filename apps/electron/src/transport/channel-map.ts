...
export const CHANNEL_MAP = {
  ...
  startYouBoxAuth: invoke(RPC_CHANNELS.onboarding.START_YOUBOX_AUTH),
  waitYouBoxAuth: invoke(RPC_CHANNELS.onboarding.WAIT_YOUBOX_AUTH),
  cancelYouBoxAuth: invoke(RPC_CHANNELS.onboarding.CANCEL_YOUBOX_AUTH),
